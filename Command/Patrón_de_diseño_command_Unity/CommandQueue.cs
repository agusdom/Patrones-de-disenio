...
public class CommandQueue{
  public static CommandQueue Instance => _instance ?? (_instance = new CommandeQueue());
  private readondly Queue <ICommand> _commandsToExecute;
 ...
 public void AddCommand(ICommand commandToEnqueue){
   _commandToExecute.Enqueue(commandToEnqueue);
