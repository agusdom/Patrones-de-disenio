...
public class VehicleBuilder{
  ...
  private readonly Dictionary<TyrePosition,Type> _types = new Dictionary<TyrePosition,Tyre>();
  ...
  public Vehicle Build(){
   ...
   foreach(var tyre in _tyres){
    var tyreInstance =    var vehicle = Object,Instantiate(tyre.Value,chassis.GetTyrePosition(tyre.Key));
  ...
  private void CheckPreConditions(){
   ...
   Assert.IsNotNull(4,_tyres.Count);
