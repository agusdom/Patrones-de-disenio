...
namespace Composite
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"El tamaño de directorio {root.Nombre} es {root.ObtenerTamaño}");
            Console.WriteLine($"El tamaño de directorio {dir1.Nombre} es {dir1.ObtenerTamaño}");
            Console.WriteLine($"El tamaño de directorio {dir2.Nombre} es {dir2.ObtenerTamaño}");
            Console.WriteLine($"El tamaño de directorio {dir3.Nombre} es {dir3.ObtenerTamaño}");
